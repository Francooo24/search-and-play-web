    ...
    <div className="flex-grow w-full max-w-5xl mx-auto px-4 md:px-8 pb-16">
      ...
      <div className="relative rounded-3xl overflow-hidden mb-10 mt-4">
        ...
        <div className="relative px-6 md:px-10 py-10 flex flex-col sm:flex-row items-start sm:items-center gap-6">
          {/* Icon */}
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center shadow-2xl shadow-amber-500/30 border-4 border-white/10 shrink-0">
            <svg className="w-10 h-10 text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.6)]" viewBox="0 0 24 24" fill="currentColor">

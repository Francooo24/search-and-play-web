...
('Caterpillar Pro',   'Score 100+ in Caterpillar Count',     '🐛', 'score',        100, 'Caterpillar Count'),
('Color Mixer',       'Score 100+ in Color Mix',             '🌈', 'score',        100, 'Color Mix'),
...
('ABC Master',        'Score 100+ in ABC Order',             '🔤', 'score', 100, 'ABC Order'),
('Blank Filler',      'Score 100+ in Fill in the Blank',     '✏️', 'score', 100, 'Fill in the Blank'),
('Affix Expert',      'Score 100+ in Prefix & Suffix',       '🔤', 'score', 100, 'Prefix & Suffix'),
('Context Reader',    'Score 100+ in Context Clues',         '📖', 'score', 100, 'Context Clues'),
('Puzzle Slider',     'Score 100+ in Picture Puzzle',        '🧩', 'score', 100, 'Picture Puzzle'),
...
('Word Associator',   'Score 100+ in Word Association',      '🧩', 'score', 100, 'Word Association'),
('Bingo Champ',       'Score 100+ in Word Bingo',            '🎯', 'score', 100, 'Word Bingo'),
('Chain Master',      'Score 100+ in Word Chain',            '🔗', 'score', 100, 'Word Chain'),
('Word Connector',    'Score 100+ in Word Connect',          '🔗', 'score', 100, 'Word Connect'),
('Ladder Climber',    'Score 100+ in Word Ladder',           '🪜', 'score', 100, 'Word Ladder'),
('Puzzle Master',     'Score 100+ in Word Puzzle',           '🔤', 'score', 100, 'Word Puzzle'),
('Debate Champion',   'Score 100+ in Debate This',           '🎭', 'score', 100, 'Debate This'),
('Fact Checker',      'Score 100+ in Fake or Fact',          '📰', 'score', 100, 'Fake or Fact'),
